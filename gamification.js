...
const Gamification = (() => {
  ...
  const THEMES = [
    ...
    { id: 'spacex', name: 'SpaceX Dark', cost: 1200, vars: {
        '--canvas': '#000000', '--surface-1': '#0a0a0a', '--surface-2': '#000000',
        '--accent-blue': '#ffffff', '--ink': '#ffffff', '--ink-muted': '#5a5a5f',
        '--hairline': '#3a3a3f', '--bg-header': 'rgba(0,0,0,0.97)',
        '--bg-nav': 'rgba(10,10,10,0.98)', '--bg-element': '#111111', '--bg-card': '#050505',
    }},
  ];
